...
public class JdbcUserDao implements UserDao {
    ...
    public User createUser(User newUser) {
        User user = null;
        String insertUserSql = "INSERT INTO users (username,password_hash,role,first_name,last_name,email) values (LOWER(TRIM(?)),?,?,?,?,?) RETURNING user_id";
        ...
        try {
            ...
            int userId = jdbcTemplate.queryForObject(insertUserSql, int.class,
                    newUser.getUsername(), password_hash, newUser.getAuthoritiesString(), newUser.getFirstName(),
                    newUser.getLastName(),
                    newUser.getEmail());
