...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "User1", "Name", "User1@gmail.com");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "User2", null, "User2@gmail.com");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "User3", "Name", "User3@gmail.com");
    ...
    public void create_user_with_null_username() {
        dao.createUser(
                new User(null, USER_3.getPassword(), "ROLE_USER", USER_3.getFirstName(), USER_3.getLastName(), USER_3.getEmail())
        );
    }
    ...
    public void create_user_with_existing_username() {
        dao.createUser(
                new User(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", USER_3.getFirstName(), USER_3.getLastName(), USER_3.getEmail())
        );
    }
    ...
    public void create_user_with_null_password() {
        dao.createUser(
                new User(USER_3.getUsername(), null, "ROLE_USER", USER_3.getFirstName(), USER_3.getLastName(), USER_3.getEmail())
        );
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User("new", "user", "ROLE_USER", "new", "user", "newuser@gmail.com");
